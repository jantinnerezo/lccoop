                            ...
                            <div class="col-md-4">
                             ...
                             <div class="col-md-4 text-right">
                                <div class="form-group">
                                    <a href="<?php echo base_url();?>admin/clients/print_view" class="btn btn-info"><span class="oi oi-eye"></span> Print view</a>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <td class="text-right"><?php echo $balance;?></td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                    ...
                                                    <?php if($member['approved'] == 1): ?>
                                                         <button class="dropdown-item account"
                                                             data-toggle="modal"
                                                             data-target="#accountModal"
                                                             data-no="<?php echo $member['userID'];?>"
                                                             data-name="<?php echo $member['firstname'] . ' ' . $member['lastname'];?>"
                                                             data-balance="<?php echo $balance; ?>"
                                                             data-bal="<?php echo $member['balance'];?>"
                                                             data-firstname="<?php echo $member['firstname'];?>"
                                                             data-lastname="<?php echo $member['lastname'];?>"
                                                             data-middlename="<?php echo $member['middlename'];?>"
                                                             data-email="<?php echo $member['email'];?>"
                                                             data-description="<?php echo $member['description'];?>"
                                                             data-gender="<?php echo $member['gender'];?>"
                                                             data-age="<?php echo $member['age'];?>"
                                                             data-birth="<?php echo $birth;?>"
                                                             data-marital="<?php echo $member['marital_status'];?>"
                                                             data-citizenship="<?php echo $member['citizenship'];?>"
                                                             data-address="<?php echo $member['address'];?>"
                                                             data-city="<?php echo $member['city'];?>"
                                                             data-zipcode="<?php echo $member['zipcode'];?>"
                        
                                                         ><span class="oi oi-person"></span> Account</button>
                                                         <div class="dropdown-divider"></div>

                                                         <button class="dropdown-item deposit" 
                                                         data-toggle="modal" 
                                                         ...
                                                         data-balance="<?php echo $balance; ?>"
                                                         data-bal="<?php echo $member['balance'];?>"
                                                         ><span class="oi oi-account-login"></span> Deposit</button>
                                                        <div class="dropdown-divider"></div>

                                                        <button class="dropdown-item withdraw"  data-toggle="modal" 
                                                         data-target="#withdrawDialog"
                                                         data-no="<?php echo $member['userID'];?>"
                                                         data-name="<?php echo $member['firstname'] . ' ' . $member['lastname'];?>"
                                                         data-balance="<?php echo $balance; ?>"
                                                         data-bal="<?php echo $member['balance'];?>"><span class="oi oi-account-logout"></span> Withdraw</button>
                                                        <div class="dropdown-divider"></div>

                                                         <button class="dropdown-item notify"
                                                          data-toggle="modal" 
                                                         data-target="#messageDialog"
                                                         data-no="<?php echo $member['userID'];?>"
                                                         data-name="<?php echo $member['firstname'] . ' ' . $member['lastname'];?>"
                                                         ><span class="oi oi-envelope-closed">  </span> Notify</button>
                                                        

                                                    <?php else: ?>
                                                        <a class="dropdown-item" href="<?php echo base_url();?>/approve_user?user_id=<?php echo $member['userID']; ?>" ><span class="oi oi-check">  </span> Approve</a>
                                                    <?php endif; ?>
              ...
              <!--  <?php echo form_open('deposit'); ?> -->
                  <div class="modal-body">
                    ...
                    <input type="hidden" id="user_name">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="amount" class="form-control" id="depamount" required placeholder="Enter an amount to deposit">
                        </div>
                  ...
                  <div class="modal-footer">
                      <button  class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button type="submit" data-toggle="modal" data-target="#depositConfirm" class="btn btn-success confirm-d"><span class="oi oi-account-login"></span> Deposit</button>
                  </div> 
               <!-- <?php echo form_close();?> -->
    ...
    <div class="modal fade" id="depositConfirm" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Confirm deposit</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
                <?php echo form_open('deposit'); ?>
                  <div class="modal-body">
                    ...
                    <input type="hidden" name="amount" id="amount-d">
                        <h5 class="modal-title" id="exampleModalLabel">Are you sure you want to continue transaction?</h5>
                   </div>
          ...
          <div class="modal-header">
            ...
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
                  ...
                  <div class="modal-body">
                    ...
                    <input type="hidden"  id="user_name">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="amount" class="form-control" id="withamount" placeholder="Enter an amount to withdraw">
                        </div>
                  ...
                  <div class="modal-footer">
                      <button  class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button type="submit" data-toggle="modal" data-target="#withdrawConfirm" class="btn btn-success confirm-w"><span class="oi oi-account-logout"></span> Withdraw</button>
                  </div>
    ...
    <div class="modal fade" id="withdrawConfirm" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Confirm withdrawal</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
                <?php echo form_open('withdrawal'); ?>
                  <div class="modal-body">
                    ...
                    <input type="hidden" name="balance" id="balance">
                    <input type="hidden" name="user_name" id="user_name">
                    <input type="hidden" name="amount" id="amount-w">
                        <h5 class="modal-title" id="exampleModalLabel">Are you sure you want to continue transaction?</h5>
                   </div>
    ...
    $(document).ready(function(){
        ...
        /*$('#table').DataTable({
         ...
         $('.confirm-d').click(function(){
                ...
                $(".modal-body #amount-d").val(amount);
            
         });


         $('.confirm-w').click(function(){

           
                var amount  =  $('#withamount').val();
                $(".modal-body #amount-w").val(amount);

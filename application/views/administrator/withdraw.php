        ...
        <div class="inner-wrapper2">
            <div class="card">
                ...
                <?php foreach($account as $user): ?>
                    ...
                    <div class="card-body">
                         <h4 class="card-title text-center text-info">Withdrawal</h4>

                         <?php echo form_open('withdrawal'); ?>
                            <div class="form-group">
                                <input type="number" class="form-control" placeholder="Amount to withdraw" name="amount">
                            </div>  
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input type="submit" class="btn btn-block btn-success" value="Withdraw">
                            </div>
                        <?php echo form_close(); ?>
                    </div>
